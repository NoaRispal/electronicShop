...
<head>
    ...
    <!-- SEO -->
    <?php 
        $metaTitle = "Electronic Store";
        $metaDesc = "Discover our wide range of electronic products: smartphones, computers and accessories.";

        if (isset($item['name'])) {
            $metaTitle = htmlspecialchars($item['name']) . " | Electronic Store";
            $metaDesc = mb_strimwidth(strip_tags($item['description']), 0, 155, "...");
        } 
        elseif (isset($category)) {
            $metaTitle = "Browse " . htmlspecialchars($category) . " | Electronic Store";
            $metaDesc = "Find all our products in " . htmlspecialchars($category) . "category. Guaranteed quality and unbeatable prices.";
        }
        // Si c'est une recherche
        elseif (isset($_GET['search'])) {
            $metaTitle = "Search results for : " . htmlspecialchars($_GET['search']);
        }
    ?>
    ...
    <?php if (isset($p['link_image'])): ?>
        <meta property="og:image" content="<?= BASE_URL . $p['link_image'] ?>">
    <?php endif; ?>
    <script>
    ...
    <script type= "module" src="<?php echo BASE_URL; ?>js/swiper.js" defer></script>
    <!-- Leaflet.js (Interactive Map) -->
    <link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css" />
    <script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"></script>
    <script src="<?php echo BASE_URL; ?>js/map.js" defer></script>
    <!-- CSS -->
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>css/styles.css">
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>css/general/button.css">
